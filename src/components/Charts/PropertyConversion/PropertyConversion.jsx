...
const data22 = [
    ...
    { name: "Feb-24", value: 48 },
    { name: "Mar-24", value: 50 },
    { name: "Apr-24", value: 47 },
    { name: "May-24", value: 52 },
    { name: "Jun-24", value: 54 },
    { name: "July-24", value: 52 },
    { name: "Aug-24", value: 50 },
    { name: "Sep-24", value: 51 },
    { name: "Oct-24", value: 49 },
    { name: "Nov-24", value: 50 },
    { name: "Dec-24", value: 48 },
];
...
export default function PropertyConversion() {
    return (
